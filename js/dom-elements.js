...
export const resumeLastBtn = document.getElementById('resume-last-btn');
export const quizSearchInput = document.getElementById('quiz-search-input');
export const tagFilterRow = document.getElementById('tag-filter-row');
export const quizTagFilter = document.getElementById('quiz-tag-filter');
export const activeFilterIndicator = document.getElementById('active-filter-indicator');
export const quizCardGrid = document.getElementById('quiz-card-grid');
export const noQuizResultsMessage = document.getElementById('no-quiz-results');
